...
<?///BEGIN EDITOR///?>
		...
		<link rel="stylesheet" href="<?= $ftp_directory;?>style/cm.css" title=contemporary type="text/css"/>
		<script type="text/javascript" src="<?= $ftp_directory;?>include/script.js"></script>
<?
		if (
			preg_match("/\.htm$/", $file)
			||
												...
												<td>
													<div class="toolbarButton" onclick="cancelEditFile();">
														<table border="0">
															<tr>
																<td>
																	<img src="<?= $ftp_directory;?>img/back.gif" border="0" alt=""/>
																</td>
																<td>
																	&nbsp;<?= $lblChangeMode;?>
																</td>
												...
												<td>
													<div class="toolbarButton" onclick="document.editFileForm.submit();">
														<table border="0">
															<tr>
																<td>
																	<img src="<?= $ftp_directory;?>img/save.gif" border="0" alt=""/>
																</td>
																<td>
																	Guardar
																</td>
...
?>
										<table cellpadding="0" cellspacing="0">
											<tr>
												<td valign="middle">&nbsp;<a class="menu" href="javascript:logOff()"><img src="<?= $ftp_directory;?>img/logoff.gif" height="24" border="0" align="middle" alt=""/></a> </td>
...
?>
		...
		<table cellpadding="0" cellspacing="0" style="height:100%;width:100%;" class="webftp">
			<tr>
				<td>
...
?>
											...
											<td>
												<div class="toolbarButton" onclick="submitForm('cd', '..');">
													<table border="0">
														<tr>
															<td>
																<img src="<?= $ftp_directory;?>img/parent.gif" border="0" alt=""/>
															</td>
															<td>
																<?=$lblUp?>
															</td>
											...
											<td>
												<div class="toolbarButton" onclick="changeMode('<?=$newMode?>');">
													<table border="0">
														<tr>
															<td>
																<img src="<?= $ftp_directory;?>img/mode.gif" border="0" alt=""/>
															</td>
															<td>
																<?=$lblChangeMode?>
															</td>
					...
					<table style="height:100%;width:100%;" border="0" cellspacing="0" cellpadding="0">
						<tr>
							<td class="leftmenu" valign="top">
								<img src="<?= $ftp_directory;?>img/1px.gif" width="212" height="1">
								<div align="center">
									<br/>
									<!-- File and folder -->
										...
										<tr>
											<td valign="top" class="leftmenuitem">
												<table id="action_delete" border="0" cellspacing="0" cellpadding="0" style="display:none;">
													<!-- Delete File -->
													<tr>
														<td valign="middle"><img src="<?= $ftp_directory;?>img/menu_delete.gif" alt=""/></td>
														<td valign="middle">
												...
												<table id="action_zipdl" style="display:none;" border="0" cellspacing="0" cellpadding="0">
													...
													<tr>
														<td valign="middle"><img src="<?= $ftp_directory;?>img/zip.gif" alt=""/></td>
														<td valign="middle">
												...
												<table id="action_view" style="display:none;" border="0" cellspacing="0" cellpadding="0">
													<tr>
														<td valign=center><img src="<?= $ftp_directory;?>img/menu_edit.gif" alt=""/></td>
														<td valign=center>
												...
												<table id="action_edit" style="display:none;" border="0" cellspacing="0" cellpadding="0">
													...
													-->
													<tr>
														<td valign="middle"><img src="<?= $ftp_directory;?>img/menu_edit.gif" alt=""/></td>
														<td valign="middle">
												...
												<table id="action_rename" style="display:none;" border="0" cellspacing="0" cellpadding="0">
													...
													-->
													<tr>
														<td VALIGN=top><img src="<?= $ftp_directory;?>img/menu_rename.gif" alt=""/></td>
														<td VALIGN=top>
												...
												<table border="0" cellspacing="0" cellpadding="0">
													<tr>
														<td VALIGN=top><img src="<?= $ftp_directory;?>img/upload.gif" border="0" alt=""/></td>
														<td VALIGN=top>
													...
													<tr>
														<td valign="top"><img src="<?= $ftp_directory;?>img/createdir.gif" border="0" alt=""/></td>
														<td valign="top">
													...
													<tr>
														<td valign="top"><img src="<?= $ftp_directory;?>img/gotodir.gif" border="0" alt=""/></td>
														<td valign="top">
	...
	?>
													...
													<tr>
													<td class="filenamecol" width="20"><a href="javascript:selectEntry('<?=$fileAction?>','<?=$escapedFileName?>','filename<?=$counter?>','<?=addslashes($myDir["user"])?>','<?=$myDir["perms"]?>','<?=$delAction;?>')" ondblclick="submitForm('<?=$fileAction;?>','<?=$escapedFileName?>')"><img src="<?= $ftp_directory;?>img/<?=$fileType['imgfilename'];?>" align="top" border="0" alt=""/></a></td>
