	...
	<table width="100%" border="<?= $border;?>">
		...
		<tbody style="vertical-align:top;">
			...
			<tr style="height:35px; vertical-align:top;">
				...
				<td width="25%" align="right" style="padding-right:0.8cm;">$ <?= number_format($H_DB->GetOne("SELECT importe FROM h_cobros WHERE comprobanteid = {$comprobante['id']}" ), 2, ',', '.');?></td>
			...
			<tr style="height:15px; vertical-align:top;">
				...
				<td width="25%" align="right" style="padding-right:0.8cm;">&nbsp;</td>
